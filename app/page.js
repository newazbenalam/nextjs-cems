                ...
                <nav className="main-nav">
                    ...
                    <div className="search-input">
                      <form id="search" action="#">
                        <input type="text" placeholder="Type Something" id='searchText' name="searchKeyword" onClick="handle" />
            ...
            <div className="item item-2">
              <div className="header-text">
                ...
                <div className="buttons">
                  ...
                  <div className="icon-button">
                    <a href="#"><i className="fa fa-play"></i> Whats the best result?</a>
                  </div>
                </div>
              </div>
            </div>
            <div className="item item-3">
              <div className="header-text">
                ...
                <div className="buttons">
                  ...
                  <div className="icon-button">
                    <a href="#"><i className="fa fa-play"></i> Whats Online Course?</a>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div className="container">
      ...
      <div className="row event_box">
        ...
        <div className="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress development">
          <div className="events_item">
            <div className="thumb">
              <a href="#"><img height={310} style={{ objectFit: 'cover'}} src="assets/1713299014367.jpeg" alt="" /></a>
              <span className="category">Wordpress</span>
